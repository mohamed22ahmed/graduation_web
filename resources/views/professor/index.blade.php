          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a href="/addExam" class="dropdown-item">Add Exam</a>
                    <a href="/addMcq" class="dropdown-item">Add MCQ</a>
                    <a href="/addTf" class="dropdown-item">Add True & False</a>
                    <a href="/deleteExam" class="dropdown-item">Delete Exam</a>
                    <a href="/deleteMcq" class="dropdown-item">Delete MCQ</a>
                    <a href="/deleteTf" class="dropdown-item">Delete True & False</a>
                </div>
            </li>

            <li class="nav-item">
              <a href="/chooseExam" class="nav-link">Show Exam</a>
            </li>
            <li class="nav-item">
