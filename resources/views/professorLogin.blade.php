        ...
        <section id="contact" class="bg-light py-5">
            <div class="container">
              <div class="row">
                <div class="col-lg-9">
                  <h3>Login Now</h3>
                  <p class="lead"><bold>Hint!</bold> If you are a student login as student  </p>
                  <form method="post">
                      @csrf
                    ...
                    <a href="{{ url('/proLogin') }}"class=" btn btn-outline-primary  mr-3">login as Professor</a>
                    <a href="{{ url('/login') }}" class="btn btn-outline-secondary "> login as Student</a>
                  </form>
                </div>
